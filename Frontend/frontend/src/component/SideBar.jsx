    ...
    return(
        ...
        <aside className="bg-white border-r border-gray-300 flex flex-col justify-between w-72 h-screen pb-6 ">
            <div >
                ...
                <div className="max-w-11/12 pt-7 pl-3">
                    ...
                    <button className="group w-full h-13 hover:bg-blue-50 hover:rounded-xl transition-all duration-200">
                        <div className="flex flex-row ml-8">
                            <AiOutlineCode  lineHome className="size-6 mt-1  group-hover:text-logo text-gray-600 transition-colors duration-200" />
                    ...
                    <button className="group w-full h-13 hover:bg-blue-50 hover:rounded-xl transition-all duration-200">
                        <div className="flex flex-row ml-8">
                            <AiOutlineTrophy    lineHome className="size-6 mt-1  group-hover:text-logo text-gray-600 transition-colors duration-200" />
                    ...
                    <button className="group w-full h-13 hover:bg-blue-50 hover:rounded-xl transition-all duration-200">
                        <div className="flex flex-row ml-8">
                            <AiOutlineHistory   lineHome className="size-6 mt-1  group-hover:text-logo text-gray-600 transition-colors duration-200" />
            ...
            <div className="max-w-11/12 pl-3 flex flex-col gap-1">
                
                    <button className="group w-full h-13 hover:bg-blue-50 hover:rounded-xl transition-all duration-200">
                        <div className="flex flex-row ml-8">
                            <AiOutlineUser tlineCode  lineHome className="size-6 mt-1  group-hover:text-logo text-gray-600 transition-colors duration-200" />
                    ...
                    <button className="group w-full  h-13 hover:bg-blue-50 hover:rounded-xl transition-all duration-200">
                        <div className="flex flex-row ml-8">
                            <AiOutlineSetting   lineHome className="size-6 mt-1  group-hover:text-logo text-gray-600 transition-colors duration-200" />
